...
#change here
export MEMO="runtest-direct-size-$QSIZE"
...
#export POLICY_LAUNCH=fix-pool // SHOULD I USE THIS??????????
#export POLICY_LAUNCH_ARGS=10:16 #average queue = 2kb //  16 functions in the pool with a maximum of 10 pending requests before adding more function
...
## the set of ddf  // This is the settings for direct connection mode ???????
